...
const Strategy = () => {
  return (
    <div className='strategy-container'>
      ...
      <Spiral img={frame4} icon={icon4} title={"Tecnologia"} text={"Além do SEO que gera vendas, somos especialistas na criação e manutenção de sites em WordPress e UX e UI Design. Essa habilidade nos permite ajudar empresas que não contam com um time interno ou fornecedor de confiança nessas áreas. Essas soluções são muito importantes para a correção dos erros técnicos encontrados na auditoria técnica. Caso você já tenha um fornecedor ou equipe interna, trabalhamos super bem em conjunto, sem nenhum problema."} flex={"row-reverse"} />
    </div>
  );
}
